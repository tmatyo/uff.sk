                        ...
                        <tr v-for="(u, i) in urls" :key="u.id">
                            ...
                            <td class="border border-slate-200 p-1 text-slate-500 dark:text-slate-400 text-center overflow-hidden bg-red-200 dark:bg-red-200">
                                <a href="#" class="flex justify-center h-full w-full text-center align-middle" @click="openModal(u.id)" >
                                    <svg class="h-8 w-8 mr-0 text-red-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <circle cx="12" cy="12" r="10" />  <line x1="15" y1="9" x2="9" y2="15" />  <line x1="9" y1="9" x2="15" y2="15" /></svg>
                                </a>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-sky-800 rounded-lg shadow dark:bg-sky-800">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-300 dark:text-gray-300">Are you sure you want to delete this product?</h3>
